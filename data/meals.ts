...
const catalog: Record<string, MealSeed[]> = {
  ...
  "seafood-coast": [
    ...
    { slug: "grilled-salmon", name: "سلمون مشوي", description: "سلمون مع خضار مشوية.", image: IMG.tuna, price: 78, rating: 4.6, calories: 480, protein: 42, carbs: 10, fat: 28, category: "popular", isPopular: true, spicyOption: false },
  ...
  "healthy-bowl": [
    { slug: "quinoa", name: "بول كينوا", description: "كينوا مع خضار مشوية.", image: IMG.bowl, price: 36, rating: 4.4, calories: 380, protein: 34, carbs: 42, fat: 12, category: "popular", isPopular: true, spicyOption: false },
    ...
    { slug: "avocado", name: "توست أفوكادو", description: "خبز أسمر مع أفوكادو.", image: IMG.green, price: 28, rating: 4.3, calories: 280, protein: 24, carbs: 28, fat: 14, category: "menu", spicyOption: false },
    { slug: "smoothie", name: "سموذي أخضر", description: "سبانخ وموز وتفاح.", image: IMG.shake, price: 22, rating: 4.2, calories: 180, protein: 16, carbs: 28, fat: 2, category: "menu", spicyOption: false },
    { slug: "poke", name: "بوكيه سلمون", description: "أرز مع سلمون طازج.", image: IMG.bowl, price: 48, rating: 4.6, calories: 420, protein: 36, carbs: 40, fat: 14, category: "popular", isPopular: true, spicyOption: false },
    { slug: "wrap", name: "راب دجاج صحي", description: "راب أسمر مع خضار.", image: IMG.shawarma, price: 30, rating: 4.3, calories: 360, protein: 32, carbs: 34, fat: 10, category: "menu" },
    { slug: "soup-veg", name: "شوربة خضار", description: "خضار طازجة بدون كريمة.", image: IMG.soup, price: 16, rating: 4.1, calories: 140, protein: 12, carbs: 18, fat: 4, category: "menu", spicyOption: false },
    { slug: "energy", name: "وجبة طاقة", description: "بول + سموذي.", image: IMG.bowl, price: 49, rating: 4.5, calories: 420, protein: 36, carbs: 48, fat: 12, category: "offers", isOffer: true, offerPrice: 42, spicyOption: false },
    { slug: "falafel-bowl", name: "بول فلافل", description: "فلافل مخبوز مع سلطة.", image: IMG.falafel, price: 32, rating: 4.2, calories: 360, protein: 30, carbs: 40, fat: 12, category: "menu", spicyOption: false },
    { slug: "yogurt", name: "زبادي بالعسل", description: "زبادي يوناني وعسل ومكسرات.", image: IMG.dessert, price: 18, rating: 4.4, calories: 220, protein: 20, carbs: 22, fat: 6, category: "popular", isPopular: true, spicyOption: false },
  ],
  "luqma-mart": [
