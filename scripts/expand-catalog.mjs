...
const EXTRA_PACKS = [
  ...
  {
    file: "15-fried-chicken.json",
    cuisine: "فرايد تشيكن",
    tags: ["فرايد تشيكن", "دجاج مقرمش", "باكت"],
    restaurants: [
      ["crispy-bucket", "كريسبي باكت"],
      ["golden-wing", "الجناح الذهبي"],
      ["strip-lab", "مختبر الستربس"],
      ["fire-thigh", "فخذ النار"],
      ["bucket-house", "بيت الباكت"],
      ["crunch-yard", "ساحة المقرمش"],
      ["wing-street", "شارع الوينجز"],
      ["family-fry", "فرايد العائلة"],
    ],
    meals: [
      ["باكت ٣ قطع", "ثلاث قطع دجاج مقرمشة مع صوص.", 28, 780, 42, 35, 40, true],
      ["ستربس دجاج", "أصابع دجاج مقرمشة مع صوصات.", 26, 640, 36, 38, 28, false],
      ["وينجز حارة", "أجنحة دجاج بصلصة حارة.", 24, 520, 28, 18, 32, true],
      ["فخذ مقرمشة", "فخذ دجاج متبلة ومقلية.", 22, 480, 30, 12, 28, false],
      ["صدر كريسبي", "صدر دجاج مقرمش كامل.", 30, 560, 38, 20, 26, false],
      ["ساندويتش تشيكن", "خبز مع دجاج مقرمش وخس ومايونيز.", 27, 720, 32, 55, 34, false],
      ["بطاطس عائلية", "بطاطس مقلية كبيرة مع توابل.", 14, 420, 5, 52, 22, false],
      ["كول سلو", "سلطة ملفوف كريمية.", 10, 180, 2, 14, 12, false],
      ["ذرة حلوة", "كوب ذرة بالزبدة.", 9, 160, 4, 28, 4, false],
      ["حلقات بصل", "حلقات بصل مقرمشة.", 12, 340, 4, 36, 18, false],
    ],
  },
];
